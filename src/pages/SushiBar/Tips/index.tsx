...
const tips: readonly Tip[] = [
    {
        ...
        image: BentoSquare,
        description:
            'Deposit your xAPE into BentoBox to passively earn yield through an xAPE investment strategy, or use as collateral within Kashi and future Bento dapps.',
        href: '#'
    },
    {
        ...
        image: Vote,
        description:
            'As an xAPE holder, your share of the staking pool correlates to the weight of your vote when participating in on-chain governance.',
        href: '#'
    },
    {
        ...
        image: AaveSquare,
        description:
            'Deposit your xAPE into Aave to receive aXAPE to earn collateral interest and borrowing power.',
        href: '#'
    },
    {
        ...
        description: (
            <>
                ...
                by depositing xAPE or by staking your APE LP tokens from the{' '}
                <Link to="#" className="underline">
                    APE/xAPE
                </Link>{' '}
                and/or{' '}
    ...
    return (
        <>
            ...
            <div className="w-full max-w-2xl mb-4">
                ...
                <div className="text-high-emphesis text-h4">Make the most of your xAPE.</div>
                <div className="text-gray-500 py-3">
                    You can leave the bar and exchange your xAPE for APE (as well as collect any earned interest) at
                    any time. However, there are more ways to use xAPE to maximize your yield potential!
                </div>
